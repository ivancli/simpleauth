            ...
            <div class="modal-content">
                ...
                <slot name="modal-footer">
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" v-if="cancelText" @click="action(false,3)">{{ cancelText }}</button>
                        <button type="button" class="btn btn-primary" v-if="okText" @click="action(true,4)">{{ okText }}</button>
                    </div>
                </slot>
            </div>
        </div>
